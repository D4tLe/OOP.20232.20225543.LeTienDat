...
public class AddCDController {
    ...
    private void addCD() throws IOException {
        CompactDisc CD = new CompactDisc(tfTitle.getText(), tfCategory.getText(), tfDirector.getText(), tfArtist.getText(), Integer.parseInt(tfLength.getText()), Float.parseFloat(tfCost.getText()));
